...
#tool nuget:?package=MSTest.TestAdapter&version=2.2.4-preview-20210412-01
...
public string getMSTestAdapterPath(){
    ...
    if(nugetPaths.Count == 0){
        throw new Exception(
            ...
            "You might need to add '#tool nuget:?package=MSTest.TestAdapter&version=version=2.2.4-preview-20210412-01' " + 
